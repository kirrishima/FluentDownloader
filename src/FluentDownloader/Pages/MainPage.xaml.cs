...
namespace FluentDownloader.Pages
{
    ...
    public sealed partial class MainPage : Page, IDialogService, IDownloadDependencies, IProgressBar, INotifyPropertyChanged
    {
        ...
        private void InitializeServices()
        {
            ...
            // Получаем сториборды из ресурсов PlaylistRangePanel
            ...
            // Подготовительная логика перед показом: установить начальные значения
            Action prepare = () =>
            {
                // гарантируем стартовые значения перед проигрыванием show
                PlaylistRangePanel.Opacity = 0;
                PlaylistTranslate.Y = 8;
            };

            // Создаём аниматор: следит за свойством IsCurrentUrlIsPlaylist
